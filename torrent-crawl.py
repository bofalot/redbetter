...
# This file will need a re-vamp.
#

#def main():
#    parser = argparse.ArgumentParser(formatter_class=argparse.ArgumentDefaultsHelpFormatter, prog='redactedbetter.py')
...
#                        default=os.path.expanduser('~/.redactedbetter.py/config'))
#    parser.add_argument('--cache', help='the location of the cache',
#                        default=os.path.expanduser('~/.redactedbetter.py/cache-crawl'))
#
...
#    except:
#        print "please run redactedbetter.py once"
#        sys.exit(2)
#
